    ...
    <Fragment>
      ...
      >
        ...
        <div className="nav justify-content-center social-icons">
          <a target="_blank" href="https://www.instagram.com/kennsu.dev/?hl=en">
            <i className="fab fa-instagram" />
          </a>
          <a target="_blank" href="https://www.linkedin.com/in/kennysuqiu/">
            <i className="fab fa-linkedin-in" />
          </a>
          <a target="_blank" href="https://github.com/kennysuqiu">
